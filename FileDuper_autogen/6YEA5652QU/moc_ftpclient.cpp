...
template <> constexpr inline auto FtpClient::qt_create_metaobjectdata<qt_meta_tag_ZN9FtpClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'allFilesRecursivelyFinished'
        QtMocHelpers::SignalData<void(const QStringList &, bool)>(13, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QStringList, 14 }, { QMetaType::Bool, 10 },
        }}),
        // Signal 'filesCollected'
        QtMocHelpers::SignalData<void(const QStringList &, bool)>(15, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QStringList, 14 }, { QMetaType::Bool, 10 },
        }}),
        // Signal 'removeFinished'
        QtMocHelpers::SignalData<void(const QString &, bool)>(16, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 17 }, { QMetaType::Bool, 10 },
        }}),
    };
...
void FtpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->allFilesRecursivelyFinished((*reinterpret_cast<std::add_pointer_t<QStringList>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 7: _t->filesCollected((*reinterpret_cast<std::add_pointer_t<QStringList>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 8: _t->removeFinished((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (FtpClient::*)(const QStringList & , bool )>(_a, &FtpClient::directoriesOnlyFinished, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (FtpClient::*)(const QStringList & , bool )>(_a, &FtpClient::allFilesRecursivelyFinished, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (FtpClient::*)(const QStringList & , bool )>(_a, &FtpClient::filesCollected, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (FtpClient::*)(const QString & , bool )>(_a, &FtpClient::removeFinished, 8))
            return;
    }
}
...
// SIGNAL 6
void FtpClient::allFilesRecursivelyFinished(const QStringList & _t1, bool _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 6, nullptr, _t1, _t2);
}

// SIGNAL 7
void FtpClient::filesCollected(const QStringList & _t1, bool _t2)
{
