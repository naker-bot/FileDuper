...
template <> constexpr inline auto NpuManager::qt_create_metaobjectdata<qt_meta_tag_ZN10NpuManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(enum NpuCapability, bool)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void NpuManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->capabilityChanged((*reinterpret_cast<std::add_pointer_t<enum NpuCapability>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
