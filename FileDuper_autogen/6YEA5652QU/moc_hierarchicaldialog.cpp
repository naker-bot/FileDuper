...
namespace {
struct qt_meta_tag_ZN18HierarchicalDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto HierarchicalDialog::qt_create_metaobjectdata<qt_meta_tag_ZN18HierarchicalDialogE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "HierarchicalDialog",
        "loadDirectoriesFromFtp",
        "",
        "expandAll",
        "collapseAll",
        "selectAll",
    ...
    return QtMocHelpers::metaObjectData<HierarchicalDialog, qt_meta_tag_ZN18HierarchicalDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject HierarchicalDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18HierarchicalDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18HierarchicalDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18HierarchicalDialogE_t>.metaTypes,
    nullptr
} };
...
void *HierarchicalDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18HierarchicalDialogE_t>.strings))
