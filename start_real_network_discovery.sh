...
echo "🔍 ENIGMACHAT - ECHTE NETZWERK-DISCOVERY"
echo "========================================"

cat > /home/nex/c++/enigmachat_real_network.java << 'EOF'
import javax.swing.*;
import java.awt.*;
...
echo "✅ EnigmaChat mit echter Netzwerk-Discovery erstellt"

# Kompiliere und starte
export JAVA_HOME=/usr/lib/jvm/java-17-openjdk
export PATH=$JAVA_HOME/bin:$PATH

echo "🔧 Kompiliere EnigmaChat Real Network..."
javac enigmachat_real_network.java

if [ $? -eq 0 ]; then
    echo "✅ Kompilierung erfolgreich!"
    echo ""
    echo "🌐 STARTE ENIGMACHAT MIT ECHTER NETZWERK-DISCOVERY"
    echo "=================================================="
    echo "🔍 Die App scannt jetzt das echte lokale Netzwerk"
    echo "🌐 Findet alle aktiven Geräte in deinem Subnetz"
    echo "📡 Versucht echte Verbindungen herzustellen"
    echo ""
    
    java enigmachat_real_network
else
